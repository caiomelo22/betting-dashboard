...
v-model="bet.type" :items="betTypeOptions" outlined dense
                        :rules="[validationService.required(bet.type)]" class="text-field" @change="bet_type_changed"
/>
                </div>
                <div v-if="bet.type != 'Total'">
                    ...
                    <NumberField
v-else-if="bet.type == 'Spread'" field-title="Spread" :type="numberFieldEnum.Line"
